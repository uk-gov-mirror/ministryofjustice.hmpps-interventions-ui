...
describe(ActionPlanConfirmationPresenter, () => {
  ...
  describe('saveAndContinueFormAction', () => {
    it('returns a relative URL of the action plan’s add-activities page', () => {
      ...
      const presenter = new ActionPlanConfirmationPresenter(sentReferral, serviceCategory, actionPlan)
  ...
  describe('text', () => {
    describe('title', () => {
      it('includes the name of the service category', () => {
        ...
        const actionPlan = draftActionPlanFactory.justCreated(sentReferral.id).build()
        const presenter = new ActionPlanConfirmationPresenter(sentReferral, socialInclusionServiceCategory, actionPlan)
  ...
  describe('errorSummary', () => {
    ...
    describe('when a non-empty array of errors is passed in', () => {
      it('returns a summary of the errors, with the correct index appended to the field ID', () => {
        ...
        const presenter = new ActionPlanConfirmationPresenter(sentReferral, serviceCategory, actionPlan, errors)
