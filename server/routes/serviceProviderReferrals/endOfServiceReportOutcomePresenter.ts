...
export default class EndOfServiceReportOutcomePresenter {
  ...
  readonly text = {
    // TODO this should be the 'Social inclusion: end of service report' and on previous screen too
    title: `About desired outcome ${this.desiredOutcomeNumber}`,
    subtitle: `Desired outcome ${this.desiredOutcomeNumber}`,
