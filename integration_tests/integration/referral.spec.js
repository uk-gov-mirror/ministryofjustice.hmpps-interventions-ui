...
import deliusOffenderFactory from '../../testutils/factories/deliusOffender'
...
describe('Referral form', () => {
  ...
  it('User starts a referral, fills in the form, and submits it', () => {
    ...
    const deliusOffender = deliusOffenderFactory.build({ firstName: 'Geoffrey' })
    ...
    cy.stubGetOffenderByCRN('X320741', deliusOffender)
